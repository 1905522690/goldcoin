...
<div class="fl w249 memberNav">
    ...
    <div class="list" style="display:block;">
      <ul>
        ...
        <li><a href="<?php echo WEB_APP; ?>?memberpassword.html" class="aNow">修改用户密码</a></li>
      </ul>
    </div>
    <h2>常见问题</h2>
    <div class="list">
...
<div class="fr w722">
    <!--内容-->
  <form name="editpassword" id="editpassword" enctype="multipart/form-data" method="post" action="<?php echo WEB_APP; ?>do/?UserLogin-editpassword.html">
    <div class="newsForm">
       <ul>
         <li><em>原始密码：</em><input name="oldpassword" type="password" class="input1" datatype="*" nullmsg="请输入原始密码" /></li>
         <li><em>新密码：</em><input name="password1" type="password" class="input1" datatype="*" nullmsg="请输入新密码！" /></li>
         <li><em>密码确认：</em><input name="password2" type="password" class="input1" datatype="*" recheck="password1" nullmsg="请再输入一次密码！" errormsg="您两次输入的密码不一致！" /></li>
         <li><input type="submit" class="btn1" value="确  认" /><input type="reset" class="btn1 btn2" value="取  消" /></li>
       </ul>
    </div>
  </form>
    <!--内容End-->
