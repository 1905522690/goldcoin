...
<div class="fl w249 memberNav">
    ...
    <h2 class="h2Now">常见问题</h2>
    <div class="list" style="display:block;">
      <ul>
        <li><a href="<?php echo WEB_APP; ?>?faq.html" class="aNow">常见问题</a></li>
      </ul>
    </div>
</div>
<div class="fr w722">
    <!--内容-->
    <div class="memberNews2">
        <ul>
          <?php $_plist = TagAttrLoop::emspagelist('cn_faq','id desc','10','','page','','',''); $_from = $_plist['all']; Template::$_tplval['page'] = $_plist['page']; Template::$_tplval['pagejson'] = json_encode($_plist['page']); if (!is_array($_from) && !is_object($_from)){ settype($_from, 'array'); }if (count($_from)){foreach($_from as $key=>Template::$_tplval['list']){ ?>
          <li><a href="<?php echo WEB_APP; ?>?faqshow/id/<?php echo Template::$_tplval['list']['id']; ?>.html"><?php echo Template::$_tplval['list']['question']; ?></a></li>
          <?php }} unset($_from);?>
        </ul>
    </div>
